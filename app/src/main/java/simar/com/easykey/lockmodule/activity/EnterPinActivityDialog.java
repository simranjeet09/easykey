package simar.com.easykey.lockmodule.activity;
...
import simar.com.easykey.lockmodule.fingerprint.FingerPrintListener;
import simar.com.easykey.lockmodule.fingerprint.FingerprintHandler;
import simar.com.easykey.lockmodule.pinlockview.IndicatorDots;
import simar.com.easykey.lockmodule.pinlockview.PinLockListener;
import simar.com.easykey.lockmodule.pinlockview.PinLockView;
import simar.com.easykey.lockmodule.util.Animate;
import simar.com.easykey.lockmodule.util.Utils;


public class EnterPinActivityDialog extends Activity {
    ...
    public static Intent getIntent(Context context, boolean setPin) {
        Intent intent = new Intent(context, EnterPinActivityDialog.class);
